        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[15px] sm:text-xs text-muted-foreground">Active Drivers</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[15px] sm:text-xs text-muted-foreground">Avg Speed km/h</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[15px] sm:text-xs text-muted-foreground">Total Fleet</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[15px] sm:text-xs text-muted-foreground">Real-time Updates</p>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        >
          <div className="p-3 sm:p-4 border-b border-border flex items-center justify-between bg-card/50 backdrop-blur">
            ...
            <span className="text-[15px] sm:text-xs text-muted-foreground font-light">
        ...
        >
          <div className="flex items-center justify-between px-1">
            ...
            <span className="text-[15px] sm:text-xs text-muted-foreground">{drivers.length} total</span>
          </div>
              ...
              >
                <div className="flex items-start justify-between mb-2 sm:mb-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-[15px] sm:text-xs text-muted-foreground font-mono">{d.id}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  {d.status === "active" && (
                    <div className="flex items-center gap-1 sm:gap-1.5 text-foreground">
                      ...
                      <span className="text-[15px] sm:text-xs text-muted-foreground">km/h</span>
                    </div>
                  )}
                </div>
                ...
                <div className="mt-2 pt-2 border-t border-border space-y-1">
                  <div className="flex items-center gap-1 sm:gap-1.5 text-muted-foreground">
                    ...
                    <span className="text-[15px] sm:text-xs truncate">{d.zone}</span>
                  </div>
                  <div className="flex items-center gap-1 sm:gap-1.5 text-muted-foreground">
                    <Clock className="h-3 w-3 shrink-0" strokeWidth={1.5} />
                    <span className="text-[15px] sm:text-xs truncate">{d.lastSeen}</span>
                  </div>
                </div>
              </div>
            ))}
