import { LayoutDashboard, MapPin, AlertTriangle, Users, LogOut, Shield, Camera } from "lucide-react";
    ...
    <Sidebar className="border-r border-border bg-background">
      <div className="p-4 sm:p-6 flex items-start gap-2 sm:gap-3 border-b border-border">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[10px] sm:text-xs text-muted-foreground">Security Platform</p>
        </div>
      </div>

      <SidebarContent className="px-3 sm:px-4 py-4 sm:py-6">
        <SidebarGroup>
          <SidebarGroupLabel className="text-[10px] sm:text-xs font-medium text-muted-foreground px-2 sm:px-3 mb-2 sm:mb-3 uppercase tracking-wider">Menu</SidebarGroupLabel>
          <SidebarGroupContent>
