    ...
    <div className="p-3 sm:p-6 space-y-3 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
          <Badge
            variant="outline"
            className={`font-light text-[15px] sm:text-xs ${
              isCameraActive
          ...
          <Badge
            variant="outline"
            className="bg-primary/15 text-primary border-[1px] border-primary/30 font-light text-[15px] sm:text-xs"
          >
          ...
          {faceMatches.length > 0 && (
            <Badge
              variant="outline"
              className="bg-destructive/15 text-destructive border-[1px] border-destructive/30 font-light text-[15px] sm:text-xs"
            >
          ...
          <Badge
            variant="outline"
            className="bg-muted text-muted-foreground border-[1px] font-light text-[15px] sm:text-xs"
          >
          ...
          <div className="rounded-lg border bg-card p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3 sm:mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-mono text-[15px] sm:text-xs tracking-widest uppercase text-muted-foreground">
                  Live Camera Feed
                </h3>
              </div>
              <div className="flex items-center gap-2 flex-wrap">
                {isModelLoaded && isCameraActive && (
                  <>
                    <label className="text-[15px] sm:text-xs font-light text-muted-foreground cursor-pointer flex items-center gap-1.5">
                      <input
                        type="checkbox"
                        checked={autoCapture}
                ...
                {isModelLoaded && (
                  <Button
                    ...
                    className="font-mono text-[15px] sm:text-xs h-7 sm:h-8 px-2 sm:px-3"
                  >
                ...
                {isCameraActive && (
                  <Button
                    ...
                    className="font-mono text-[15px] sm:text-xs h-7 sm:h-8 px-2 sm:px-3 gap-1"
                  >
                    {isRecording ? (
            ...
            <div className="relative bg-black rounded-lg overflow-hidden min-h-[340px] sm:min-h-0 sm:aspect-video">
              ...
              {isRecording && (
                <div className="absolute top-2 left-2 z-10 flex items-center gap-1.5 bg-black/70 rounded-full px-2.5 py-1">
                  ...
                  <span className="text-[15px] font-mono text-red-400 tracking-wider">REC {formatDuration(recordingDuration)}</span>
                </div>
              )}
              {!isCameraActive && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1">
                          <Badge
                            variant="outline"
                            className={`${qualityColors[face.quality]} text-[15px] font-light border-[1px]`}
                          >
                            {face.quality.toUpperCase()}
                          </Badge>
                          <Badge
                            variant="outline"
                            className="bg-primary/15 text-primary border-[1px] border-primary/30 text-[15px] font-light"
                          >
                            {face.confidence}%
                          </Badge>
                        </div>
                      ...
                      {match && (
                        <div className="flex items-center gap-2 p-2 rounded bg-destructive/15 border-[1px] border-destructive/30">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-[15px] text-destructive/80">
