            ...
            <thead>
              <tr className="border-b border-border">
                {["Driver", "Status", "Zone", "Speed", "Last Seen"].map((h) => (
                  <th key={h} className="p-2 sm:p-3 text-left text-[10px] sm:text-xs font-normal tracking-wider uppercase text-muted-foreground">{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              ...
              >
                <td className="p-2 sm:p-3">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] sm:text-xs text-muted-foreground font-light font-mono">{d.id}</p>
                    </div>
                  </div>
                </td>
                <td className="p-2 sm:p-3">
                  <Badge 
                    ...
                    className="inline-flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs"
                  >
                    <span className={cn(
                ...
                <td className="p-2 sm:p-3">
                  <div className="flex items-center gap-1 sm:gap-1.5 text-muted-foreground">
                    ...
                    <span className="font-light text-[10px] sm:text-xs truncate">{d.zone}</span>
                  </div>
                </td>
                <td className="p-2 sm:p-3">
                ...
                <td className="p-2 sm:p-3">
                  <div className="flex items-center gap-1 sm:gap-1.5 text-muted-foreground">
                    ...
                    <span className="font-light text-[10px] sm:text-xs">{d.lastSeen}</span>
                  </div>
                </td>
              </tr>
            ))}
